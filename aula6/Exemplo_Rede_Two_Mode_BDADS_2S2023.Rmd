...
setwd(".")
compras <- read.table(paste(getwd(), "Exemplo Rede TwoMode.csv", sep="/"),header=TRUE,sep = ";", dec=",")
```
...
```
Veja como os resultados fazem sentido pelas proximidades entre os dados de Joao e Maria, Pedro e Luisa, Jose e Paulo
